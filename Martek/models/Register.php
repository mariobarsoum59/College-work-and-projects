...
//                    $this->panelContent_2.='Username  : '.$this->postArray['username'].'<br>';
//                    $this->panelContent_2.='Email  : '.$this->postArray['email'].'<br>';
//                    $this->panelContent_2.='Address  : '.$this->postArray['address'].'<br>';
//                    $this->panelContent_2.='Profile Picture  : '.$this->postArray['profilepic'].'<br>';
