...
//end METHOD -   set the page heading
    ...
    {//set the panel 1 heading
        if ($this->loggedin)
            {
            $this->panelHead_1 = '<h3>My Cart</h3>';
            }
        else
            {
            $this->panelHead_1 = '<h3>Please login to view Your Cart</h3>';
            }
    }
...
//end METHOD - //set the panel 1 heading
    ...
    {//set the panel 1 content                                  
        if ($this->loggedin)
            ...
            $sql = 'SELECT * FROM products as p inner join cart as c where c.UserID=' . $row["UserID"] . ' AND c.ProductID=p.ProductID';
    ...
    public function setPanelContent_2()
    {
        ...
        if ($this->loggedin)
            ...
            if (isset($_POST['btnCheckOut']))
                ...
                //$SQLUpdateQuantity='UPDATE products SET UnitsInStock = UnitsInStock - 1 WHERE ProductID = 2';
